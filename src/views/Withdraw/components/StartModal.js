...
const StartModal = ({
  ...
  const SAFETY_CHECK = <span style={errorStyles}> These amounts trigger Toroid's Safety Check  </span>
  const EXCEEDS_BALANCE = <span style={errorStyles}> This withdrawal exceeds your Toroid balance </span>
        ...
        <StyledForm onSubmit={handleSubmit}>
          <StyledRows>
            <StyledShells>
                ...
                <StyledShellBalance> { state.getIn([ 'shells', shellIx, 'shell', 'shellsOwned', 'display' ]) + ' Toroids'} </StyledShellBalance>
            </StyledShells>
